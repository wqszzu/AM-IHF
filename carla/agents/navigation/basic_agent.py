...
class BasicAgent(object):
    ...
    def trace_route_length(self, start_location, end_location):
        """
        Calculates the shortest route and length between a starting and ending locations.
        """
        return self._global_planner.trace_route_length(start_location, end_location)
