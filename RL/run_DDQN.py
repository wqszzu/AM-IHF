...
import models.DuelingDQN.model as DDQN_brain
import argparse
import logging
import random
import glob
...
def Simulation(args):
    ...
    try:
        ...
        agent = DDQN_brain.DuelingDQN(world.state_space,
                                      world.action_space,
                                      hidden_layers=512,
                                      lr=0.001,
                                      memory_size=2000,
        ...
        models_dir="./models/DuelingDQN/models/"
        ...
        for i in tqdm(range(args.simTimeSlice)):
            try:
                ...
                divide_flag,action=RL_decision(world,state,agent,window_step)
